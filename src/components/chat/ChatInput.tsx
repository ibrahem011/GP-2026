                ...
                {isRecording ? (
                    <div className="flex-1 bg-red-50 dark:bg-red-900/20 rounded-2xl p-2 flex items-center justify-between animate-pulse border border-red-100 dark:border-red-900/30">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="p-2 text-gray-500 hover:text-red-500 transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none rounded-full"
                            >
                            ...
                            <button
                                ...
                                className="w-10 h-10 rounded-full bg-red-500 text-white flex items-center justify-center shadow-lg hover:bg-red-600 transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
                            >
                    ...
                    <>
                        ...
                        <button
                            ...
                            disabled={uploading}
                            aria-label={uploading ? 'جاري الرفع' : (hasMediaPermission ? 'إرفاق صورة' : 'لا يوجد صلاحية للصور')}
                            className={`w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 dark:bg-zinc-700 text-gray-500 hover:text-primary transition-colors hover:bg-primary/10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${uploading ? 'opacity-50' : ''}`}
                        >
                        ...
                        <div className="flex-1 bg-gray-100 dark:bg-zinc-700 rounded-2xl p-2 flex items-center gap-2">
                            <button
                                ...
                                className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-yellow-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-full"
                            >
                        ...
                        <div className="flex gap-1">
                            {message.trim() ? (
                                <button
                                    ...
                                    className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center shadow-lg shadow-primary/30 hover:scale-105 active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                >
                                ...
                                <button
                                    ...
                                    className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                >
