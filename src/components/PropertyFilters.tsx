        ...
        <div className="flex items-center gap-3">
            ...
            <div className="flex bg-white/40 dark:bg-zinc-800/40 backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-xl p-1 shadow-sm">
                <button
                    ...
                    className={`p-1.5 rounded-lg transition-all duration-300 focus-visible:ring-2 focus-visible:outline-none ${viewMode === 'list' ? 'bg-white dark:bg-zinc-700 shadow-sm text-primary' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
                    title="عرض كقائمة"
                ...
                <button
                    ...
                    className={`p-1.5 rounded-lg transition-all duration-300 focus-visible:ring-2 focus-visible:outline-none ${viewMode === 'grid' ? 'bg-white dark:bg-zinc-700 shadow-sm text-primary' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
                    title="عرض كشبكة"
