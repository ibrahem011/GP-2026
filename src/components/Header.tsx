                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative flex items-center" ref={dropdownRef}>
                                <button
                                    ...
                                    className={`relative flex touch-target items-center justify-center rounded-full shadow-sm border transition-all duration-200 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary/60 ${isScrolled
