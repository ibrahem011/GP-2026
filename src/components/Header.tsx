                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative flex items-center" ref={dropdownRef}>
                                <button
                                    ...
                                    className={`relative flex items-center justify-center size-10 rounded-full shadow-sm border transition-all duration-300 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary ${isScrolled
                            ...
                            <button
                                onClick={logout}
                                className={`p-2 transition-colors rounded-full focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-red-500 ${isScrolled ? 'text-gray-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30' : 'text-white/80 hover:text-white hover:bg-white/20'}`}
                                title="تسجيل الخروج"
