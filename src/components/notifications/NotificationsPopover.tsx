        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
                    ...
                    <button onClick={onClose} className="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 transition-colors focus-visible:ring-2 focus-visible:outline-none" aria-label="إغلاق">
