...
// ⚡ Bolt Performance Optimization: Wrapped PropertyCard in React.memo to prevent unnecessary re-renders in frequently updated lists (like search results) when receiving primitive props.
