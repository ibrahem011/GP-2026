...
// Memoizing PropertyCard to prevent unnecessary re-renders cascading from
// frequent parent state updates (like debounced search query changes) in list views.
