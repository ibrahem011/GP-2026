...
// ⚡ Bolt Performance Optimization: Memoize PropertyCard to prevent unnecessary re-renders when parent components (like home page, search results) update state frequently (e.g., search queries, filters).
