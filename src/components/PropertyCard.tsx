...
// ⚡ Bolt Performance Optimization: Wrapped PropertyCard in memo to prevent unnecessary re-renders during frequent list parent state updates (e.g., search queries)
