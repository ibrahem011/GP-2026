...
// ⚡ Bolt Performance Optimization: Wrapped PropertyCard in React.memo to prevent unnecessary re-renders when parent components (like SearchPageClient) update their state, improving rendering performance for large lists of properties.
