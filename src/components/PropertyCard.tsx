...
// ⚡ Bolt Performance Optimization: Wrapped PropertyCard in React.memo to prevent unnecessary re-renders in list views during parent state updates (e.g., search filtering).
export const PropertyCard = React.memo(function PropertyCardComponent({
    id,
    title,
    location,
    price,
