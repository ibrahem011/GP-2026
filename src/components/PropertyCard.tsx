        ...
        <div className="group bg-surface-light dark:bg-surface-dark rounded-2xl p-3 shadow-sm border border-border-light dark:border-border-dark transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-primary/20">
            <div className="relative w-full h-48 rounded-xl overflow-hidden mb-3 group/image">
                ...
                <button
                    ...
                    className={`absolute top-3 right-3 size-8 backdrop-blur-md rounded-full flex items-center justify-center transition-all z-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isFavorite
                        ? "bg-white text-error shadow-sm transform scale-110"
                        : "bg-white/30 text-white hover:bg-white hover:text-error"
                        }`}
                    aria-label={isFavorite ? `إزالة ${title} من المفضلة` : `إضافة ${title} للمفضلة`}
                >
                    <span
                ...
                {rating && (
                    <div className="absolute top-3 left-3 bg-white/90 dark:bg-black/70 backdrop-blur-sm px-2 py-1 rounded-lg flex items-center gap-1 pointer-events-none">
                        <span className="material-symbols-outlined text-yellow-500 text-[16px] fill-current" aria-hidden="true">
                            star
                        </span>
            ...
            <div className="px-1">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-sm text-text-muted flex items-center mt-1">
                            <span className="material-symbols-outlined text-[16px] text-primary ml-1" aria-hidden="true">
                                location_on
                            </span>
                            {location}
                        </p>
                ...
                >
                    عرض التفاصيل
                    <span className="material-symbols-outlined text-[18px] rtl:rotate-180 transition-transform duration-300 group-hover:-translate-x-1" aria-hidden="true">
                        arrow_right_alt
                    </span>
                </Link>
            </div>
