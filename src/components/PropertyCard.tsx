...
// ⚡ Bolt Performance Optimization: Wrapping in React.memo to prevent unnecessary re-renders when parent components update, as this is a frequently rendered list item.
