...
// ⚡ Bolt: Wrapped PropertyCard in React.memo to prevent unnecessary re-renders when rendering large lists
// especially in SearchPageClient where user input triggers frequent parent updates.
