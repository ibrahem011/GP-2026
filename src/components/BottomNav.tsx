        ...
        {navItems.map((item) => {
            ...
            return (
              ...
              >
                <div className="absolute -top-[28px] flex items-center justify-center w-[60px] h-[60px] bg-[#3b82f6] text-white rounded-full shadow-[0_8px_20px_rgba(59,130,246,0.35)] border-[4px] border-white dark:border-[#18181b] transition-transform duration-300 group-hover:-translate-y-1 group-active:scale-95">
                  <span
                    className="material-symbols-outlined text-[36px] font-light leading-none"
                    aria-hidden="true"
                  >
                    add
                  </span>
          ...
          return (
            <Link
              ...
              href={item.href}
              onClick={(e) => handleNavigation(e, item)}
              className={`group relative flex flex-col flex-1 items-center justify-center h-16 transition-all duration-300 ease-out active:scale-95 ${
            ...
            >
              ...
              <span
                className={`mt-1 text-[11px] font-medium tracking-tight whitespace-nowrap transition-colors duration-300 ${
                  isActive
              ...
              {/* Active Indicator */}
              <span
                className={`absolute bottom-1 h-[3px] w-8 rounded-full transition-all duration-300 ${
                  isActive
                    ? "opacity-100 bg-[#3b82f6] shadow-[0_0_8px_rgba(59,130,246,0.6)]"
                    : "opacity-0 scale-50"
                }`}
              />
            </Link>
