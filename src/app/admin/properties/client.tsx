...
export default function AdminPropertiesClient({ initialStatus, initialQ }: AdminPropertiesClientProps) {
    const router = useRouter();
    
    const [properties, setProperties] = useState<PropertyRow[]>([]);
    const [loading, setLoading] = useState(true);
    const [actionLoading, setActionLoading] = useState<string | null>(null);
    const [filter, setFilter] = useState<'pending' | 'available' | 'rejected' | 'all'>(initialStatus as any);
