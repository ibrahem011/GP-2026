    ...
    <div className="min-h-screen bg-background-light pb-[13rem] dark:bg-background-dark">
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-surface-light/95 backdrop-blur dark:border-zinc-800 dark:bg-surface-dark/92">
        <div className="mx-auto max-w-6xl px-4 py-3 lg:px-6">
          <div className="flex items-center justify-between gap-3">
            <button aria-label="الرجوع للخلف" type="button" onClick={() => router.back()} className="inline-flex touch-target items-center justify-center rounded-full border border-gray-200 text-gray-700 transition hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-primary/50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-900"><span aria-hidden="true" className="material-symbols-outlined">arrow_forward</span></button>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200 bg-surface-light/95 px-4 pb-2 pt-3 backdrop-blur dark:border-zinc-800 dark:bg-surface-dark/95 lg:hidden" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 0.5rem)' }}>
        ...
        <div className="flex items-center gap-2">
          {currentStep > 1 ? <button aria-label="الخطوة السابقة" type="button" onClick={handlePrev} className="inline-flex h-12 w-12 items-center justify-center rounded-xl border border-gray-300 text-gray-700 transition hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-primary/50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-900"><span aria-hidden="true" className="material-symbols-outlined">arrow_forward</span></button> : null}
