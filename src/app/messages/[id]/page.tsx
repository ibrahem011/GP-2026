        ...
        <main className="flex flex-col h-screen bg-gray-50 dark:bg-black overflow-hidden" dir="rtl">
            ...
            <div className="bg-white dark:bg-zinc-800 border-b border-gray-100 dark:border-zinc-700 p-3 flex items-center justify-between shadow-sm z-20">
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => router.back()}
                        className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-gray-100 dark:hover:bg-zinc-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                        aria-label="الرجوع"
                        title="الرجوع"
                    >
                ...
                <div className="flex gap-2">
                    <button
                        className="w-10 h-10 rounded-full bg-gray-50 dark:bg-zinc-700 flex items-center justify-center text-gray-500 hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                        aria-label="اتصال"
                        title="اتصال"
                    >
