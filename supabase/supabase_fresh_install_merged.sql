...
-- ================================================================
-- GAMASA PROPERTIES - FRESH INSTALL MERGED BUNDLE
-- Purpose: single-run bootstrap for a NEW Supabase project.
-- Base: manual/MASTER_SCHEMA.sql
-- Appended missing logic from: 006_user_data_fetch.sql + fixed 009_admin_system_expansion.sql + 010_booking_landlord_notes.sql
-- This merged file is intended to replace the stale manual snapshot for fresh installs.
-- ================================================================
